...
public class MyDefaultCommentGenerator implements CommentGenerator {
    ...
    public void addFieldComment(Field field,
        ...
        //this.addRemarkComments(field, introspectedTable, introspectedColumn);
        this.addFieldComments_my(field,introspectedTable, introspectedColumn);
    }

    public void addRemarkComments(Field field,
            IntrospectedTable introspectedTable,
            IntrospectedColumn introspectedColumn) {
        if (suppressAllComments) {
            return;
    ...
    private void addFieldComments_my(Field field,IntrospectedTable introspectedTable,
            IntrospectedColumn introspectedColumn){
